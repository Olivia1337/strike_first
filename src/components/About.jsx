...
function About() {
  return (
    <section className="w-full h-auto bg-stone-900 flex items-center justify-center p-[5%]">
      <div className="flex flex-col items-center justify-center text-white w-full md:w-1/2 text-center">
        <h1 className="text-[3em] md:text-[5em] text-stone-200 font-header">
          Strike First Muay Thai
        </h1>
        <p className="text-[1em] md:text-[1.2em] font-text text-stone-200 w-[90%] lg:w-[70%] mx-auto">
        ...
        <Link to="/contact" aria-label="Find us on the contact page">
